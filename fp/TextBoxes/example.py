...
if __name__ == "__main__":
    ...
    if proc_train_ticket:
        detector = dt.TextBoxesDetect(model_def = '/home/gaolin/TextBoxes/models/train_ticket.prototxt', 
            model_weights = '/home/gaolin/TextBoxes/models/train_ticket.caffemodel',scales= ((300,300),(700,700),(300,700)) )
    else:
        detector = dt.TextBoxesDetect(model_def = '/home/tangpeng/fapiao/fp/fp/TextBoxes/models/fapiao.prototxt', 
            model_weights = '/home/tangpeng/fapiao/fp/fp/TextBoxes/models/fapiao.caffemodel',scales= ((700,700),(700,1600),(1600,1600)))
